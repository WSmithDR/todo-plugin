import { ALLOW, advise, mergeDecisions, type Decision } from "../../core/lib/protocol/protocol.ts"
import { sessionSetup } from "../../core/rules/session-setup/session-setup.ts"
import { clearTouched, rememberHead } from "../../core/lib/session-state/session-state.ts"
import { currentHead } from "../../core/lib/git/git.ts"
import { hasTodoDir, storeAvailable } from "../../core/lib/env/env.ts"
import { decideAfter, decideBefore, decideSessionClose } from "../../core/lib/pipeline/pipeline.ts"
